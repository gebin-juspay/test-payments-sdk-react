...
```sh
npm install test-payments-sdk-react
```
...
```ts
import TestSDKReact from 'test-payments-sdk-react';
```
...
test-payments-sdk-react is distributed under [AGPL-3.0-only](https://github.com/juspay/test-payments-sdk-react/src/main/LICENSE.md) license.
