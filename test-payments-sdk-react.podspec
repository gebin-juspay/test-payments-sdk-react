...
Pod::Spec.new do |s|
  s.name         = "test-payments-sdk-react"
  ...
  s.source       = { :git => "https://github.com/juspay/test-payments-sdk-react.git", :tag => "v#{s.version}" }

  s.static_framework = true
  s.source_files = "ios/**/*.{h,m,mm,swift}"

  s.dependency "React-Core"
  s.dependency "TestPaymentServices", hyper_sdk_version
end
